...
Future<dynamic> buildBottomSheet2(BuildContext context,TextEditingController controller,String index,ItemModel Item,String value) {
                  ...
                  onPressed: () {
                    if(controller.text!=null){
                      ...
                      WarningDialog(
                          ...
                          onYes: () async {
                            loading(true);
                            ItemServices().update(Item,index, controller.text.trim());
                            Get.back();
                            loading(true);
                          });
                    }else{
